...
public class FilesInOut {
    ...
    public static void main(String[] args) throws FileNotFoundException 
    {
        ...
        Scanner scan = new Scanner(input); LinkedList <String> inputFile = new LinkedList <String>();
        ...
        (LinkedList <String> inputFile, boolean uppercase)
      {
    	...
    	for(int i = 0; i<inputFile.size(); i++) 
        {
    		if(uppercase) 
                ...
                {
    		stringHolder = capitalise(inputFile.get(i).substring(0,inputFile.get(i).indexOf(" ")+1)); 
                stringHolder = stringHolder + capitalise(inputFile.get(i).substring(0,inputFile.get(i).indexOf(". "); //capitalise the middle intial and adda full stop
